...
################################################################################
## "0002" will be replaced by .sh file
...
# match_regexp(
#   vs=vs.dx.icd.regexp.bunch2[c(-89, -90, -102, -68, -69), ], fclaim = "MEDICAL_CLAIM_DIAGNOSIS_0002.txt",
...
# match_regexp(
#   vs=vs.other.regexp.bunch2, fclaim = "MEDICAL_CLAIM_DIAGNOSIS_0002.txt",
#   col.match='DIAGNOSIS_CODE',
#   chunksize = 0, col.out = NULL,
#   test=F, verbose=T, towrite=T, header=T, sep='|',
#   dir_raw = inDir, dir_out = outDir
...
# 
# match_regexp(
#   vs=vs.proc.icd.regexp.bunch2, fclaim = "MEDICAL_CLAIM_DIAGNOSIS_0002.txt",
#   col.match='DIAGNOSIS_CODE',
#   chunksize = 0, col.out = NULL,
#   test=F, verbose=T, towrite=T, header=T, sep='|',
#   dir_raw = inDir, dir_out = outDir
...
# 
# match_regexp(
#   vs=vs.proc.other.regexp.bunch2, fclaim = "MEDICAL_CLAIM_DIAGNOSIS_0002.txt",
#   col.match='DIAGNOSIS_CODE',
#   chunksize = 0, col.out = NULL,
#   test=F, verbose=T, towrite=T, header=T, sep='|',
#   dir_raw = inDir, dir_out = outDir
...
# 
# match_regexp(
#   vs=vs.system.regexp.bunch2, fclaim = "MEDICAL_CLAIM_DIAGNOSIS_0002.txt",
#   col.match='DIAGNOSIS_CODE',
#   chunksize = 0, col.out = NULL,
#   test=F, verbose=T, towrite=T, header=T, sep='|',
#   dir_raw = inDir, dir_out = outDir
...
# 
# match_regexp(
#   vs=vs.ubrev.regexp.bunch2, fclaim = "MEDICAL_CLAIM_DIAGNOSIS_0002.txt",
#   col.match='DIAGNOSIS_CODE',
#   chunksize = 0, col.out = NULL,
#   test=F, verbose=T, towrite=T, header=T, sep='|',
#   dir_raw = inDir, dir_out = outDir
...
match_regexp(
  vs = vs.dx.icd.regexp, fclaim = "ct_medical_claim_diagnosis_0002.txt",
  col.match ='DIAGNOSIS_CODE',
  chunksize = 0, col.out = NULL,
  test = F, verbose = T, towrite = T, header = T, sep = '|',
  dir_raw = inDir, dir_out = outDir
...
match_regexp(
  vs = vs.tmp, fclaim = "ct_medical_claim_diagnosis_0002.txt",
  col.match = 'DIAGNOSIS_CODE',
  chunksize = 0, col.out = NULL,
  test = F, verbose = T, towrite = T, header = T, sep='|',
  dir_raw = inDir, dir_out = outDir
