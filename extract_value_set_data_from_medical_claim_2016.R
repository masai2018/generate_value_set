...
################################################################################
## .sh file will replace "2016" by "2012-2017"
...
# match_regexp(
#   vs = vs.ubrev.regexp[c(-1, -23, -32), ], fclaim = "ct_medical_split_2016.txt",
...
# # ## part 2 CPT, HCPCS
# match_regexp(
#   vs = vs.proc.other.regexp[c(123:155, 157:168), ], fclaim = "ct_medical_split_2016.txt",
...
# match_regexp(
#   vs = vs.proc.icd.regexp, fclaim = "ct_medical_split_2016.txt",
...
# }
# match_regexp(
#   vs = vs.tmp, fclaim = "ct_medical_split_2016.txt",
#   col.match = 'PROCEDURE_CODE',
#   chunksize = 0, col.out = NULL,
#   test = F, verbose = T, towrite = T, header = T, sep='|',
#   dir_raw = inDir, dir_out = outDir
...
# match_regexp(
#   vs = vs.cost.regexp, fclaim = "ct_medical_split_2016.txt",
#   col.match = 'REVENUE_CODE',
#   chunksize = 0, col.out = NULL,
#   test = F, verbose = T, towrite = T, header = T, sep='|',
#   dir_raw = inDir, dir_out = outDir
...
# # match_regexp(
# #   vs = vs.system.regexp[426:430, ], fclaim = "ct_medical_split_2016.txt",
# #   col.match = 'icd_procedure_code',
...
#     fclaim = "ct_medical_split_2016.txt",
#     col.match = colmatch,
#     chunksize = 0, col.out = NULL,
#     test = F, verbose = T, towrite = T, header = T, sep='|',
#     dir_raw = inDir, dir_out = outDir
...
match_regexp(
  vs = vs.dx.icd.regexp, fclaim = "ct_medical_split_2016.txt",
